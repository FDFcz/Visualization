...
public class SimulationScene {
    ...
    public SimulationScene()
    {
        ...
        sceneObjects.add(new Workplace(new Vector3f(0f, 0.2f, 0), new Vector3f(0, 0f, 0), new Vector3f(1, 1, 1)));
        sceneObjects.add(new Workplace(new Vector3f(0.2f, 0.2f, 0), new Vector3f(0, 0f, 0), new Vector3f(1, 1, 1)));
