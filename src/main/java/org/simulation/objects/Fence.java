...
public class Fence extends SceneObject{
    public Fence(Vector3f position, Vector3f rotation, Vector3f scale) {
        ...
        metalicMesh = new Mesh(new Vertex[] {
                new Vertex(new Vector3f(-0.083f,  0.13f, 0.0f),StatusColors.purple, new Vector2f(0.4f,0.4f)),
                new Vertex(new Vector3f(-0.083f, 0.136f, 0.0f),StatusColors.purple,new Vector2f(0.4f,0.6f)),
                new Vertex(new Vector3f( 0.083f, 0.13f, 0.0f),StatusColors.purple,new Vector2f(0.6f,0.6f)),
                new Vertex(new Vector3f( 0.083f, 0.136f, 0.0f),StatusColors.purple,new Vector2f(0.6f,0.6f)),
